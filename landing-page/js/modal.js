var Modal = (function () {
  ...
  var close = function (event) {
    ...
    if (target.classList.contains('registerGuruhFormModal')) {
      $("#registerGuruhFormModal").modal('hide');
    }
    else if (target.classList.contains('registerGuritoFormModal')) {
      $("#registerGuritoFormModal").modal('hide');
    }
    else {
      /**
